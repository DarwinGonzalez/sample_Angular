...
export class ProductoService {
  ...
  getProductosOferta(): Observable<Producto[]> {
    return this.http.get<Producto[]>(baseURL + 'productos?oferta=true')
      .pipe(catchError(this.procesaHttpmsjService.gestionError));
  }
  ...
  setProducto(producto): Observable<Producto> {
    return this.http.put<Producto>(baseURL + 'productos/' + producto.id, producto, httpOptions)
      .pipe(catchError(this.procesaHttpmsjService.gestionError));
  }
}
